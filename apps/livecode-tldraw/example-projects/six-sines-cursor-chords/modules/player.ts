...
export async function runFunc(ctx: TimeContext) {
  ...
  try {
    ...
    while (!isSixSinesReady()) {
      ...
      await __tcvVisualizedAwait("cursor-chords/player", "3eb2be5d-8cd5-4c36-9889-2a070b40f582", ctx.waitSec(0.05));
    }
    console.log(
    ...
    while (true) {
      ...
      await __tcvVisualizedAwait("cursor-chords/player", "5231c772-e80a-4491-97fe-2ed91d08f458", ctx.waitSec(1 / 60));
    }
  } finally {
    unsubscribe?.();
