...
export const SYNTH_NAME = "six-sines-recording/synth";
const FALLBACK = {
  preset:
...
/** One ordered next-quantum batch: note edges and every held note's expressions. */
...
export default async function describe(ctx: TimeContext) {
  console.log(
    "Run the take player; this module provides its Six Sines audio bridge.",
  );
