...
export const params = canvasParams(
  ...
  },
  {
    ...
    cascades: {
      ...
      farMergeFrom: {
        label: "far merge from cascade (0 = off)",
        min: 0,
        max: 9,
        step: 1,
      },
      ...
      preAverageFrom: {
        label: "pre-average from cascade (0 = off)",
        min: 0,
        max: 9,
        step: 1,
      },
...
const configFromParams = (): RadianceCascadeConfig => ({
  ...
  farMergeMode: params.cascades.farMergeMode as MergeMode,
  farMergeFrom: params.cascades.farMergeFrom,
  preAverage: params.cascades.preAverage,
  preAverageFrom: params.cascades.preAverageFrom,
