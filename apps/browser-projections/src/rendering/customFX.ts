...
const horizontalAlternateDisplaceFs = glsl`
precision highp float;
...
void main() {
  // create n horizontal lines; alternate r between -1 and 1
  float r = 1.0;
...
export class HorizontalAlternateDisplace extends CustomShaderEffect {
  ...
  constructor(width = 1280, height = 720) {
    super(horizontalAlternateDisplaceFs, {}, width, height)
...
export class PointZoom extends CustomShaderEffect {
  ...
  constructor(inputs: { src: ShaderSource }, width = 1280, height = 720) {
    super(pointZoomFs, inputs, width, height)
