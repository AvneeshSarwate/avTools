...
import { launch, type CancelablePromiseProxy, type TimeContext, xyZip, cosN, sinN, Ramp, tri, naiveSleep } from '@/channels/channels';
...
onMounted(async () => {
  try {
    ...
    const code = () => { //todo template - is this code-array pattern really needed in the template?
      ...
      let lerpLoop: CancelablePromiseProxy<any> | undefined = undefined
