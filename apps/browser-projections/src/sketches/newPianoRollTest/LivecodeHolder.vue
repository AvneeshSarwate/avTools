...
const activePlayback = ref<{ handle: ClipPlaybackHandle; context: CancelablePromiseProxy<any> } | null>(null)
const activePlaybackContext = ref<CancelablePromiseProxy<any> | null>(null)
const activeSynthPlayback = ref<CancelablePromiseProxy<any> | null>(null)
