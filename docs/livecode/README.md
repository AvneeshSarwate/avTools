...
| Location | Meaning |
| --- | --- |
| `docs/livecode/current/` | Concrete description of the checked-in code as of 2026-07-21, extended for the canvas-params slice on 2026-08-13. Each file's status line records what was checked when. |
