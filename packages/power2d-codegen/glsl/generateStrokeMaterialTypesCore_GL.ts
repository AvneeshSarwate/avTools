...
export const RAW_SUFFIX = '.strokeMaterial.glsl';
export const OUTPUT_SUFFIX = '.strokeMaterial.gl.generated.ts';
...
export interface GenerateStrokeMaterialTypesSourceResult {
  typesSource: string;
}

export function generateStrokeMaterialTypesSource(shaderCode: string, shaderBaseName: string): GenerateStrokeMaterialTypesSourceResult {
  ...
  vertexSourceLines.push('');
  vertexSourceLines.push(shaderCode.trim());
  vertexSourceLines.push('');
  ...
  fragmentSourceLines.push('');
  fragmentSourceLines.push(shaderCode.trim());
  fragmentSourceLines.push('');
  fragmentSourceLines.push(`\n${uniformStruct.name} load_${uniformStruct.name}() {`);
