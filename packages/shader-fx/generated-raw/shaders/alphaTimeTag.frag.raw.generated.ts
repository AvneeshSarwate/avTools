...
const AlphaTimeTagUniformsLayoutSize = 4;
...
export class AlphaTimeTagEffect extends CustomShaderEffect<AlphaTimeTagUniforms, AlphaTimeTagInputs> {
  ...
  constructor(device: GPUDevice, inputs: AlphaTimeTagInputs, width = 1280, height = 720, format: GPUTextureFormat = 'rgba16float', clearColor: GPUColor = { r: 0, g: 0, b: 0, a: 1 }) {
    super(device, inputs, {
      factory: (deviceRef, formatRef, options) => createAlphaTimeTagMaterial(deviceRef, formatRef, options),
