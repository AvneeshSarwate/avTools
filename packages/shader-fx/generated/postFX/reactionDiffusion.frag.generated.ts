...
export const ReactionDiffusionUniformMeta: UniformDescriptor[] = [
  {
    name: 'feed',
    kind: 'f32',
    bindingName: 'uniforms_feed',
    default: 0.055,
  },
  {
    name: 'kill',
    kind: 'f32',
    bindingName: 'uniforms_kill',
    default: 0.062,
  },
  {
    name: 'diffRateA',
    kind: 'f32',
    bindingName: 'uniforms_diffRateA',
    default: 1.0,
  },
  {
    name: 'diffRateB',
    kind: 'f32',
    bindingName: 'uniforms_diffRateB',
    default: 0.5,
  },
  {
    name: 'deltaT',
    kind: 'f32',
    bindingName: 'uniforms_deltaT',
    default: 1.0,
  },
  {
    name: 'brushRadius',
    kind: 'f32',
    bindingName: 'uniforms_brushRadius',
    default: 0.035,
  },
  {
    name: 'brushStrength',
    kind: 'f32',
    bindingName: 'uniforms_brushStrength',
    default: 0.85,
  },
  {
    name: 'noiseAmount',
    kind: 'f32',
    bindingName: 'uniforms_noiseAmount',
    default: 0.02,
  },
  {
    name: 'brushPosition',
    kind: 'vec2f',
    bindingName: 'uniforms_brushPosition',
    default: [0.5, 0.5],
  },
];
...
export class ReactionDiffusionEffect extends CustomShaderEffect<ReactionDiffusionUniforms, ReactionDiffusionInputs> {
  ...
  constructor(engine: BABYLON.WebGPUEngine, inputs: ReactionDiffusionInputs, width = 1280, height = 720, sampleMode: 'nearest' | 'linear' = 'linear', precision: RenderPrecision = 'half_float') {
    super(engine, inputs, {
      ...
      sampleMode,
      precision,
      uniformMeta: ReactionDiffusionUniformMeta,
    })
    this.setUniforms({
      feed: 0.055,
      kill: 0.062,
