...
export const FluidVisualizeUniformMeta: UniformDescriptor[] = [
  {
    name: 'velocityScale',
    kind: 'f32',
    bindingName: 'uniforms_velocityScale',
    default: 0.5,
  },
  {
    name: 'densityScale',
    kind: 'f32',
    bindingName: 'uniforms_densityScale',
    default: 1.0,
  },
  {
    name: 'tint',
  ...
  },
  {
    name: 'background',
    kind: 'vec3f',
    bindingName: 'uniforms_background',
    default: [0.02, 0.02, 0.025],
  },
];
...
export class FluidVisualizeEffect extends CustomShaderEffect<FluidVisualizeUniforms, FluidVisualizeInputs> {
  ...
  constructor(engine: BABYLON.WebGPUEngine, inputs: FluidVisualizeInputs, width = 1280, height = 720, sampleMode: 'nearest' | 'linear' = 'linear', precision: RenderPrecision = 'half_float') {
    super(engine, inputs, {
      ...
      sampleMode,
      precision,
      uniformMeta: FluidVisualizeUniformMeta,
    })
    this.setUniforms({
      velocityScale: 0.5,
      densityScale: 1.0,
