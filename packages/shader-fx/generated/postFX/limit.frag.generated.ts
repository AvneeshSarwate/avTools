...
import { CustomShaderEffect, type ShaderSource, type RenderPrecision, type UniformDescriptor, type ShaderUniforms, type Dynamic } from '@avtools/shader-fx/babylon';
...
export const LimitUniformMeta: UniformDescriptor[] = [
  {
    name: 'minFunction',
    kind: 'u32',
    bindingName: 'uniforms_minFunction',
    default: 0,
  },
  {
    name: 'maxFunction',
    kind: 'u32',
    bindingName: 'uniforms_maxFunction',
    default: 0,
  },
  {
    name: 'minValue',
    kind: 'f32',
    bindingName: 'uniforms_minValue',
    default: 0.0,
  },
  {
    name: 'maxValue',
    kind: 'f32',
    bindingName: 'uniforms_maxValue',
    default: 1.0,
  },
  {
    name: 'positiveOnly',
    kind: 'u32',
    bindingName: 'uniforms_positiveOnly',
    default: 0,
  },
  {
    name: 'normalize',
    kind: 'u32',
    bindingName: 'uniforms_normalize',
    default: 0,
  },
  {
    name: 'normalizeMin',
    kind: 'f32',
    bindingName: 'uniforms_normalizeMin',
    default: 0.0,
  },
  {
    name: 'normalizeMax',
    kind: 'f32',
    bindingName: 'uniforms_normalizeMax',
    default: 1.0,
  },
  {
    name: 'quantizeValueMode',
    kind: 'u32',
    bindingName: 'uniforms_quantizeValueMode',
    default: 0,
  },
  {
    name: 'valueStep',
    kind: 'f32',
    bindingName: 'uniforms_valueStep',
    default: 0.1,
  },
  {
    name: 'valueOffset',
    kind: 'f32',
    bindingName: 'uniforms_valueOffset',
    default: 0.0,
  },
  {
    name: 'quantizePositionMode',
    kind: 'u32',
    bindingName: 'uniforms_quantizePositionMode',
    default: 0,
  },
  {
    name: 'positionStep',
    kind: 'vec2f',
    bindingName: 'uniforms_positionStep',
    default: [0.0, 0.0],
  },
  {
    name: 'positionOffset',
    kind: 'vec2f',
    bindingName: 'uniforms_positionOffset',
    default: [0.0, 0.0],
  },
];
